...
public class LoginPageController implements Initializable {
    ...
    private void handleLoginBtnClick(ActionEvent event) throws IOException, SQLException, NoSuchAlgorithmException {
        ...
        if(!helper.isEmpty(uname) && !helper.isEmpty(pwd) && accountTypeComboBox.getValue() != null) {
            ...
            if(!usernameValid) {
                helper.showDialogBox(true, "Account does not exist");
            }
            else {
    ...
    public void sendEmail(String emailAddress, String randomCode) {
        ...
        String msg = "Enter the following code in the program to reset the password for your account\n";
        msg = msg + randomCode;
     ...
     * @return Id of newly generated code which is inserted in th database
     * @throws SQLException 
     */
